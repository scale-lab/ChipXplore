...
__C.DATASET.TECHLEF = "./output/SQL_dataset/SQL_dataset_tlef.json"
__C.DATASET.LEF =  "./output/SQL_dataset/SQL_dataset_lef.json"
__C.DATASET.LIB = "./output/SQL_dataset/SQL_dataset_lib.json"
__C.DATASET.DEF = "./output/SQL_dataset/SQL_dataset_def.json"

# LLM configs
__C.LLM = ConfigurationNode()
__C.LLM.NAME = 'llama3.3:70b'   
__C.LLM.TEMP = 0.1   
